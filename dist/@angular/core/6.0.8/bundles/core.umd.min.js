...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Fe,He=new(Fe=function Fe(e){this.full=e,this.major=e.split(".")[0],this.minor=e.split(".")[1],this.patch=e.split(".").slice(2).join(".")})("6.0.8"),Le="ngDebugContext",Be="ngOriginalError",ze="ngErrorLogger";function Ue(e){return e[Le]}function Qe(e){return e[Be]}function Ze(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];e.error.apply(e,u(t))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
