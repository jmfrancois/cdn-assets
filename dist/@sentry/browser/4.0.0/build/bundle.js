/*! @sentry/browser 4.0.0 (3efa557c) | https://github.com/getsentry/sentry-javascript */
	...
	var InboundFilters = /** @class */ (function () {
	    ...
	    InboundFilters.prototype.getPossibleEventMessages = function (event) {
	        ...
	        if (evt.message) {
	            ...
	            try {
	                ...
	                dist_1$3.error("Cannot extract message for event " + event.event_id);
	                return [];
	            }
	        }
	        else {
	    ...
	    InboundFilters.prototype.getEventFilterUrl = function (event) {
	        ...
	        try {
	            ...
	            dist_1$3.error("Cannot extract url for event " + event.event_id);
	            return '';
	        }
	    };
