/*! @sentry/browser 5.6.0 (c6d0ebf9) | https://github.com/getsentry/sentry-javascript */
        ...
        GlobalHandlers.prototype._eventFromIncompleteRejection = function (stacktrace, error) {
            ...
            if (event.exception.values && event.exception.values[0]) {
                event.exception.values[0].mechanism = {
                    data: __assign({ incomplete: true, mode: stacktrace.mode }, (stacktrace.message && { message: stacktrace.message }), (stacktrace.name && { name: stacktrace.name })),
                    handled: false,
                    type: stacktrace.mechanism,
                };
            }
