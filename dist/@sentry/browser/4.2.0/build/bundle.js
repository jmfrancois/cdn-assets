/*! @sentry/browser 4.2.0 (4b4e172) | https://github.com/getsentry/sentry-javascript */
var Sentry = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    unwrapExports(misc);
    var misc_1 = misc.isNodeEnv;
    var misc_2 = misc.getGlobalObject;
    var misc_3 = misc.uuid4;
    var misc_4 = misc.htmlTreeAsString;
    var misc_5 = misc.htmlElementAsString;
    var misc_6 = misc.parseUrl;
    var misc_7 = misc.getEventDescription;
    var misc_8 = misc.consoleSandbox;
    ...
    var domain = ( _rollupPluginShim1$1 && _rollupPluginShim1 ) || _rollupPluginShim1$1;
    ...
    var Logger = /** @class */ (function () {
        ...
        Logger.prototype.log = function (message) {
            ...
            misc.consoleSandbox(function () {
                _this.console.log("Sentry Logger [Log]: " + message); // tslint:disable-line:no-console
            });
        };
        /** JSDoc */
        Logger.prototype.warn = function (message) {
            ...
            misc.consoleSandbox(function () {
                _this.console.warn("Sentry Logger [Warn]: " + message); // tslint:disable-line:no-console
            });
        };
        /** JSDoc */
        Logger.prototype.error = function (message) {
            ...
            misc.consoleSandbox(function () {
                _this.console.error("Sentry Logger [Error]: " + message); // tslint:disable-line:no-console
            });
        };
        return Logger;
    }());
    ...
    var Dedupe = /** @class */ (function () {
        ...
        Dedupe.prototype.shouldDropEvent = function (currentEvent, previousEvent) {
            ...
            if (this.isSameMessageEvent(currentEvent, previousEvent)) {
                logger_1$1.logger.warn("Event dropped due to being a duplicate of previous event (same message).\nEvent: " + misc.getEventDescription(currentEvent));
                return true;
            }
            if (this.isSameExceptionEvent(currentEvent, previousEvent)) {
                logger_1$1.logger.warn("Event dropped due to being a duplicate of previous event (same exception).\nEvent: " + misc.getEventDescription(currentEvent));
                return true;
            }
            return false;
        };
    ...
    var integrations_7 = integrations.installedIntegrations;
    var integrations_8 = integrations.getIntegrationsToSetup;
    var integrations_9 = integrations.setupIntegration;
    var integrations_10 = integrations.setupIntegrations;
    ...
    var BaseClient = /** @class */ (function () {
        ...
        function BaseClient(backendClass, options) {
            ...
            this.integrations = integrations.setupIntegrations(this.options);
        }
        /**
         * @inheritDoc
         */
    ...
    */
    ...
    var Breadcrumbs = /** @class */ (function () {
        ...
        Breadcrumbs.prototype.instrumentHistory = function () {
            ...
            var captureUrlChange = function (from, to) {
                var parsedLoc = misc_6(global$3.location.href);
                var parsedTo = misc_6(to);
                var parsedFrom = misc_6(from);
    ...
    var ReportingObserver = /** @class */ (function () {
        ...
        ReportingObserver.prototype.setupOnce = function () {
            ...
            var observer = new (misc_2().ReportingObserver)(this.handler.bind(this), {
                buffered: true,
