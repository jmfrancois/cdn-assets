...
var Sentry = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function decycle(obj, depth, memo) {
        ...
        // tslint:disable-next-line:no-unsafe-any
        var source = (isError(obj) ? objectifyError(obj) : obj);
    ...
    var ExtraErrorData = /** @class */ (function () {
        ...
        ExtraErrorData.prototype.enhanceEventWithErrorData = function (event, hint) {
            ...
            if (errorData) {
                ...
                var normalizedErrorData = safeNormalize(errorData, this.options.depth);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.eventFromMessage(message, exports.Severity.Error, hint)];
                        case 2:
                            event = _a.sent();
                    ...
                    return __generator(this, function (_a) {
                        scope.addEventProcessor(function (event) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                processedEvent.extra = __assign({}, processedEvent.extra, { arguments: safeNormalize(args, 3) });
    ...
    var Breadcrumbs = /** @class */ (function () {
        ...
        function Breadcrumbs(options) {
            ...
            this.options = __assign({ console: true, dom: true, fetch: true, history: true, sentry: true, xhr: true }, options);
        }
        /** JSDoc */
    ...
    function flush(timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getCurrentHub().getClient().flush(timeout)];
            });
        });
    }
    /**
    ...
    function close(timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, getCurrentHub().getClient().close(timeout)];
            });
        });
    }
