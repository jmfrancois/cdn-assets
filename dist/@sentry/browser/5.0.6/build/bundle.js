/*! @sentry/browser 5.0.6 (48da7b9f) | https://github.com/getsentry/sentry-javascript */
        ...
        Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
            this._breadcrumbs =
                maxBreadcrumbs !== undefined && maxBreadcrumbs >= 0
                    ? __spread(this._breadcrumbs, [normalize(breadcrumb)]).slice(-maxBreadcrumbs)
                    : __spread(this._breadcrumbs, [normalize(breadcrumb)]);
            this._notifyScopeListeners();
            return this;
        };
        /**
        ...
        FetchTransport.prototype.sendEvent = function (event) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this._buffer.add(global$2.fetch(this.url, defaultOptions).then(function (response) { return ({
