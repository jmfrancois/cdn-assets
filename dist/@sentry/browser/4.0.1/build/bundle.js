/*! @sentry/browser 4.0.1 (cd3352e0) | https://github.com/getsentry/sentry-javascript */
var Sentry = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var integrations_1 = integrations.Debug;
    ...
    var Dedupe = /** @class */ (function () {
        ...
        Dedupe.prototype.shouldDropEvent = function (currentEvent, previousEvent) {
            ...
            if (this.isSameMessageEvent(currentEvent, previousEvent)) {
                dist_1$3.warn("Event dropped due to being a duplicate of previous event (same message).\n  Event: " + currentEvent.event_id);
                return true;
            }
            if (this.isSameExceptionEvent(currentEvent, previousEvent)) {
                dist_1$3.warn("Event dropped due to being a duplicate of previous event (same exception).\n  Event: " + currentEvent.event_id);
                return true;
            }
            return false;
        };
    ...
    var InboundFilters = /** @class */ (function () {
        ...
        InboundFilters.prototype.shouldDropEvent = function (event) {
            if (this.isIgnoredError(event)) {
                dist_1$3.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + misc_6(event));
                return true;
            }
            if (this.isBlacklistedUrl(event)) {
                dist_1$3.warn("Event dropped due to being matched by `blacklistUrls` option.\nEvent: " + misc_6(event) + ".\nUrl: " + this.getEventFilterUrl(event));
                return true;
            }
            if (!this.isWhitelistedUrl(event)) {
                dist_1$3.warn("Event dropped due to not being matched by `whitelistUrls` option.\nEvent: " + misc_6(event) + ".\nUrl: " + this.getEventFilterUrl(event));
                return true;
            }
            return false;
        };
        ...
        InboundFilters.prototype.getPossibleEventMessages = function (event) {
            ...
            if (evt.message) {
                ...
                try {
                    ...
                    dist_1$3.error("Cannot extract message for event " + misc_6(event));
                    return [];
                }
            }
            else {
        ...
        InboundFilters.prototype.getEventFilterUrl = function (event) {
            ...
            try {
                ...
                dist_1$3.error("Cannot extract url for event " + misc_6(event));
                return '';
            }
        };
