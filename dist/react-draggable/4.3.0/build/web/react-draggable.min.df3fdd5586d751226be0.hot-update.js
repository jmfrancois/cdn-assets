webpackHotUpdateReactDraggable("react-draggable.min",{

/***/ "./lib/Draggable.js":
/*!**************************************!*\
  !*** ./lib/Draggable.js + 6 modules ***!
  \**************************************/
/*! exports provided: default, DraggableCore */
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/classnames/index.js (<- Module is not an ECMAScript module) */
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/prop-types/index.js (<- Module is not an ECMAScript module) */
/*! ModuleConcatenation bailout: Cannot concat with external {"commonjs":"react","commonjs2":"react","amd":"react","root":"React"} (<- Module is not an ECMAScript module) */
/*! ModuleConcatenation bailout: Cannot concat with external {"commonjs":"react-dom","commonjs2":"react-dom","amd":"react-dom","root":"ReactDOM"} (<- Module is not an ECMAScript module) */
...
/*: HTMLElement*/
{
  var node = external_commonjs_react_dom_commonjs2_react_dom_amd_react_dom_root_ReactDOM_default.a.findDOMNode(draggable);
...
var DraggableCore_DraggableCore = /*#__PURE__*/function (_React$Component) {
  ...
  function DraggableCore() {
    ...
    DraggableCore_defineProperty(_assertThisInitialized(_this), "handleDragStart", function (e) {
      ...
      var thisNode = external_commonjs_react_dom_commonjs2_react_dom_amd_react_dom_root_ReactDOM_default.a.findDOMNode(_assertThisInitialized(_this));
  ...
  _createClass(DraggableCore, [{
    ...
    value: function componentDidMount() {
      ...
      var thisNode = external_commonjs_react_dom_commonjs2_react_dom_amd_react_dom_root_ReactDOM_default.a.findDOMNode(this);
    ...
    value: function render() {
      ...
      return external_commonjs_react_commonjs2_react_amd_react_root_React_default.a.cloneElement(external_commonjs_react_commonjs2_react_amd_react_root_React_default.a.Children.only(this.props.children), {
...
function Draggable_createSuper(Derived) { return function () { var Super = Draggable_getPrototypeOf(Derived), result; if (Draggable_isNativeReflectConstruct()) { var NewTarget = Draggable_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Draggable_possibleConstructorReturn(this, result); }; }
...
var Draggable_Draggable = /*#__PURE__*/function (_React$Component) {
  ...
  Draggable_createClass(Draggable, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof window.SVGElement !== 'undefined' && external_commonjs_react_dom_commonjs2_react_dom_amd_react_dom_root_ReactDOM_default.a.findDOMNode(this) instanceof window.SVGElement) {
        this.setState({
          isElementSVG: true
        });
      }
    ...
    /*: ReactElement<any>*/
    {
      ...
      return /*#__PURE__*/external_commonjs_react_commonjs2_react_amd_react_root_React_default.a.createElement(DraggableCore_DraggableCore, _extends({}, draggableCoreProps, {
        onStart: this.onDragStart,
        onDrag: this.onDrag,
        onStop: this.onDragStop
      }), external_commonjs_react_commonjs2_react_amd_react_root_React_default.a.cloneElement(external_commonjs_react_commonjs2_react_amd_react_root_React_default.a.Children.only(children), {
        className: className,
