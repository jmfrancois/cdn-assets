define(['exports', 'module', '../util/node-array', '../query/focusable', '../element/disabled', '../observe/shadow-mutations', '../util/compare-position'], function (exports, module, _utilNodeArray, _queryFocusable, _elementDisabled, _observeShadowMutations, _utilComparePosition) {
  /*
  ...
  */
  ...
  var _observeShadowMutations2 = _interopRequireDefault(_observeShadowMutations);
  ...
  var InertSubtree = (function () {
    function InertSubtree() {
      ...
      this.shadowObserver = (0, _observeShadowMutations2['default'])({
        context: this._context,
    ...
    _createClass(InertSubtree, [{
      ...
      value: function renderInert(elements) {
        ...
        .filter(function (element) {
          return !(0, _elementDisabled2['default'])(element);
        }).forEach(makeInert);
      }
    }, {
      key: 'filterElements',
      ...
      value: function filterParentElements(element) {
        ...
        var isParentOfElement = (0, _utilComparePosition.getParentComparator)({ parent: element });
        return !this._filter.some(isParentOfElement);
      }
    }, {
      key: 'handleMutation',
