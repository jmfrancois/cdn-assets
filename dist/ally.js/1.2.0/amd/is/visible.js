define(['exports', 'module', 'array.prototype.findindex', '../get/parents', '../util/context-to-element', '../util/get-frame-element'], function (exports, module, _arrayPrototypeFindindex, _getParents, _utilContextToElement, _utilGetFrameElement) {
  ...
  function isVisibleRules() {
    ...
    if (!except.browsingContext) {
      ...
      if (_frameElement && !_isVisible(_frameElement)) {
        return false;
      }
    }
