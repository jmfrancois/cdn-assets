...
var _prototypeElementPrototypeMatches = require('../prototype/element.prototype.matches');

var _prototypeElementPrototypeMatches2 = _interopRequireDefault(_prototypeElementPrototypeMatches);

var _prototypeSvgelementPrototypeFocus = require('../prototype/svgelement.prototype.focus');

var _prototypeSvgelementPrototypeFocus2 = _interopRequireDefault(_prototypeSvgelementPrototypeFocus);
...
var _focusRelevantSupports = require('./focus-relevant.supports');

var _focusRelevantSupports2 = _interopRequireDefault(_focusRelevantSupports);
...
function isFocusRelevantRules() {
  ...
  if (!supports) {
    supports = (0, _focusRelevantSupports2['default'])();
  }
  ...
  (0, _prototypeElementPrototypeMatches2['default'])(_window);
  if (element.matches('svg a') && element.hasAttribute('xlink:href')) {
    return true;
  }

  (0, _prototypeSvgelementPrototypeFocus2['default'])(_window);
