define(['exports', 'module', 'domtokenlist-shim/dist/domtokenlist-polyfill-umd', '../event/shadow-focus', '../get/active-elements', '../get/parents', '../util/decorate-service', '../util/select-in-shadows', './focus-within.supports'], function (exports, module, _domtokenlistShimDistDomtokenlistPolyfillUmd, _eventShadowFocus, _getActiveElements, _getParents, _utilDecorateService, _utilSelectInShadows, _focusWithinSupports) {
  /*
