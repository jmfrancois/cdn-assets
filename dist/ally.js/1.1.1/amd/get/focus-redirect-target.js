define(['exports', 'module', '../is/focusable', '../query/focusable', '../query/tabbable', '../util/context-to-element', '../util/get-document', '../util/merge-dom-order', '../util/image-map', './focus-redirect-target.supports'], function (exports, module, _isFocusable, _queryFocusable, _queryTabbable, _utilContextToElement, _utilGetDocument, _utilMergeDomOrder, _utilImageMap, _focusRedirectTargetSupports) {
  'use strict';
  ...
  var _supports2 = _interopRequireDefault(_focusRedirectTargetSupports);
