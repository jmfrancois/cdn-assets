define(['exports', 'module', '../get/focus-target', '../util/decorate-context', '../util/platform'], function (exports, module, _getFocusTarget, _utilDecorateContext, _utilPlatform) {
  /*
  ...
  */
  ...
  var relevantToCurrentBrowser = _platform['default'].is.TRIDENT && (_platform['default'].is.IE10 || _platform['default'].is.IE11);
