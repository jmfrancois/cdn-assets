...
var _getInsignificantBranches = require('../get/insignificant-branches');

var _getInsignificantBranches2 = _interopRequireDefault(_getInsignificantBranches);

var _getParents = require('../get/parents');

var _getParents2 = _interopRequireDefault(_getParents);

var _utilToggleAttributeValue = require('../util/toggle-attribute-value');

var _utilToggleAttributeValue2 = _interopRequireDefault(_utilToggleAttributeValue);

var _utilComparePosition = require('../util/compare-position');

function makeElementHidden(element) {
  (0, _utilToggleAttributeValue2['default'])({
    element: element,
...
var HiddenSubtree = (function () {
  function HiddenSubtree() {
    ...
    this._context = (0, _utilNodeArray2['default'])(context || document.documentElement)[0];
    this._filter = (0, _utilNodeArray2['default'])(filter);

    this.disengage = this.disengage.bind(this);
    this.handleMutation = this.handleMutation.bind(this);
    this.isInsignificantBranch = this.isInsignificantBranch.bind(this);

    var insignificantBranches = (0, _getInsignificantBranches2['default'])({ context: this._context, filter: this._filter });
  ...
  _createClass(HiddenSubtree, [{
    ...
    value: function handleMutation(mutation) {
      if (mutation.type === 'childList') {
        ...
        (0, _utilNodeArray2['default'])(mutation.addedNodes).filter(function (element) {
    ...
    value: function isInsignificantBranch(element) {
      ...
      var isParentOfElement = (0, _utilComparePosition.getParentComparator)({ element: element });
