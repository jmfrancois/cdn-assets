...
function isOnlyTabbableRules() {
  ...
  if (!except.onlyFocusableBrowsingContext && (_utilPlatform2['default'].is.GECKO || _utilPlatform2['default'].is.TRIDENT || _utilPlatform2['default'].is.EDGE)) {
  ...
  if (nodeName === 'svg' && (_utilPlatform2['default'].is.TRIDENT || _utilPlatform2['default'].is.EDGE)) {
