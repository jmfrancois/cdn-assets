define(['exports', 'module', 'array.prototype.findindex', './tabbable', '../is/focusable', '../util/node-array'], function (exports, module, _arrayPrototypeFindindex, _tabbable, _isFocusable2, _utilNodeArray) {
  /*
  ...
  module.exports = function () {
    ...
    if (!sequence) {
      ...
      sequence = (0, _queryTabbable['default'])({
        context: context,
