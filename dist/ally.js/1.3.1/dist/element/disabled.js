...
var _isNativeDisabledSupported = require('../is/native-disabled-supported');

var _isNativeDisabledSupported2 = _interopRequireDefault(_isNativeDisabledSupported);

var _utilToggleAttribute = require('../util/toggle-attribute');

var _utilToggleAttribute2 = _interopRequireDefault(_utilToggleAttribute);
...
function disabledFocus() {
  _utilLogger2['default'].warn('trying to focus inert element', this);
}
...
function disableVideoControls(element, disabledState) {
  (0, _utilToggleAttribute2['default'])({
    element: element,
    attribute: 'controls',
