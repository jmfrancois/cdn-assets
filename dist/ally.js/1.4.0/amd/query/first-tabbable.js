(/* istanbul ignore next */ function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', './tabbable', '../is/focusable', '../util/node-array', 'array.prototype.findindex'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./tabbable'), require('../is/focusable'), require('../util/node-array'), require('array.prototype.findindex'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.tabbable, global.focusable, global.nodeArray, global.arrayPrototype);
    global.firstTabbable = mod.exports;
  }
})(this, function (module, exports, _tabbable, _focusable, _nodeArray) {
  'use strict';
