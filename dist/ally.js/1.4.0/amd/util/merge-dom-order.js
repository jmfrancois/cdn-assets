(/* istanbul ignore next */ function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', './node-array', './sort-dom-order'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./node-array'), require('./sort-dom-order'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.nodeArray, global.sortDomOrder);
    global.mergeDomOrder = mod.exports;
  }
})(this, function (module, exports, _nodeArray, _sortDomOrder) {
  'use strict';
