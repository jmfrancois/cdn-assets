define(['exports', 'module', './visible', '../get/parents', '../supports/focus-broken-image-map', './is.util'], function (exports, module, _visible, _getParents, _supportsFocusBrokenImageMap, _isUtil) {
  ...
  module.exports = function (element) {
    ...
    if (!_canFocusBrokenImageMaps['default'] && (!img.complete || !img.naturalHeight || img.offsetWidth <= 0 || img.offsetHeight <= 0)) {
      return false;
    }
