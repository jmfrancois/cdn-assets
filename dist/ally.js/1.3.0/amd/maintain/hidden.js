define(['exports', 'module', '../util/node-array', '../get/insignificant-branches', '../get/parents', '../util/toggle-attribute-value', '../util/compare-position'], function (exports, module, _utilNodeArray, _getInsignificantBranches, _getParents, _utilToggleAttributeValue, _utilComparePosition) {
    ...
    _createClass(HiddenSubtree, [{
      ...
      value: function handleMutation(mutation) {
        if (mutation.type === 'childList') {
          ...
          (0, _nodeArray['default'])(mutation.addedNodes).filter(function (element) {
