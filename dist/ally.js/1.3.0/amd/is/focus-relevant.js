define(['exports', 'module', '../get/parents', '../util/context-to-element', '../util/element-matches', './valid-tabindex', './is.util', '../supports/supports'], function (exports, module, _getParents, _utilContextToElement, _utilElementMatches, _validTabindex, _isUtil, _supportsSupports) {
  ...
  function isFocusRelevantRules() {
    ...
    if ((0, _elementMatches['default'])(element, 'svg a') && element.hasAttribute('xlink:href')) {
      return true;
    }
