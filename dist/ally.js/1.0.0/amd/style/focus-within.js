define(['exports', 'module', '../event/shadow-focus', '../supports/css-shadow-piercing-deep-combinator', '../get/active-elements', '../get/parents', '../util/decorate-service'], function (exports, module, _eventShadowFocus, _supportsCssShadowPiercingDeepCombinator, _getActiveElements, _getParents, _utilDecorateService) {
  /*
  ...
  */
  ...
  var focusEventName = 'onfocusin' in document ? 'focusin' : 'focus';
  var blurEventName = 'onfocusin' in document ? 'focusout' : 'blur';
  ...
  function applyFocusWithinClass(active) {
    ...
    if (_cssShadowPiercingDeepCombinator['default']) {
      ...
      selector += ', html ' + _cssShadowPiercingDeepCombinator['default'] + ' ' + selector;
    } else {
