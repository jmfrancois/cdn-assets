...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst nativeTypesConfig_1 = __webpack_require__(/*! ./nativeTypesConfig */ \"./src/NativeDragSources/nativeTypesConfig.ts\");\nconst NativeDragSource_1 = __webpack_require__(/*! ./NativeDragSource */ \"./src/NativeDragSources/NativeDragSource.ts\");\nfunction createNativeDragSource(type) {\n    return new NativeDragSource_1.NativeDragSource(nativeTypesConfig_1.nativeTypesConfig[type]);\n}\nexports.createNativeDragSource = createNativeDragSource;\nfunction matchNativeItemType(dataTransfer) {\n    if (!dataTransfer) {\n        return null;\n    }\n    const dataTransferTypes = Array.prototype.slice.call(dataTransfer.types || []);\n    return (Object.keys(nativeTypesConfig_1.nativeTypesConfig).filter(nativeItemType => {\n        const { matchesTypes } = nativeTypesConfig_1.nativeTypesConfig[nativeItemType];\n        return matchesTypes.some(t => dataTransferTypes.indexOf(t) > -1);\n    })[0] || null);\n}\nexports.matchNativeItemType = matchNativeItemType;\n\n\n//# sourceURL=webpack://ReactDnDHTML5Backend/./src/NativeDragSources/index.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst NativeTypes = __webpack_require__(/*! ../NativeTypes */ \"./src/NativeTypes.ts\");\nconst getDataFromDataTransfer_1 = __webpack_require__(/*! ./getDataFromDataTransfer */ \"./src/NativeDragSources/getDataFromDataTransfer.ts\");\nexports.nativeTypesConfig = {\n    [NativeTypes.FILE]: {\n        exposeProperties: {\n            files: (dataTransfer) => Array.prototype.slice.call(dataTransfer.files),\n            items: (dataTransfer) => dataTransfer.items,\n        },\n        matchesTypes: ['Files'],\n    },\n    [NativeTypes.URL]: {\n        exposeProperties: {\n            urls: (dataTransfer, matchesTypes) => getDataFromDataTransfer_1.getDataFromDataTransfer(dataTransfer, matchesTypes, '').split('\\n'),\n        },\n        matchesTypes: ['Url', 'text/uri-list'],\n    },\n    [NativeTypes.TEXT]: {\n        exposeProperties: {\n            text: (dataTransfer, matchesTypes) => getDataFromDataTransfer_1.getDataFromDataTransfer(dataTransfer, matchesTypes, ''),\n        },\n        matchesTypes: ['Text', 'text/plain'],\n    },\n};\n\n\n//# sourceURL=webpack://ReactDnDHTML5Backend/./src/NativeDragSources/nativeTypesConfig.ts?");
